...
- **Social and Leadership Experience** I earned compelling Leadership experience during the Robotics Intramural Season and Esports competitions at my school. Additionally, I frequently collaborated with classmates and took on leadership roles in group projects, guiding my team to strong academic results. Additionally I lead my entire group in Drama Class with missing members to recieve an A on our performance the entire class saw, which was difficult considering the missing team member. Another example of these skills would be when my Final Project for Game Design became corrupted due to a storage overwrite, instead of trying to get out of the Final Project, I told the teacher about the issue and that I would have it done in two days before the due date, then I proceeded to work on the project over the next two days, completed the project, created a video and document outlining how it meets all the requirements then sent it to a teacher over a cloud storage platform and email service, receiving 100% on the new project developed, while simultaneously managing final exams for other classes. Another time in American Literature class I had a class-based discussion where we had to answer questions in a large-seminar like-group, this was one of our final projects for the class, however, I answered the wrong questions by accident, so when I obtained the questions I was actually supposed to answer, my mind was immediately looking for ways to connect the questions I answered to the ones I didn't, I proceeded to connect the philosophical questions about the Crucible book to the ones I didn't answer, actively spoke majority of the time in discussion, and proceeded to recieve a congratulations by the teacher on my performance and my peers, receiving an A on the project overall.
